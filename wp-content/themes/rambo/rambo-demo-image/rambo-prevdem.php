 ...
 * @return bool
 */
function rambo_isprevdem() {
	$ti_theme = wp_get_theme();
	$theme_name = $ti_theme->get( 'TextDomain' );
	$active_theme = rambo_get_raw_option( 'template' );
	return apply_filters( 'rambo_isprevdem', ( $active_theme != strtolower( $theme_name ) && ! is_child_theme() ) );
}
 ...
 * @return bool|mixed
 */
function rambo_get_raw_option( $opt_name ) {
 ...
 */
if ( rambo_isprevdem() ) {
	load_template( get_template_directory() . '/rambo-demo-image/rambo-pre-functions.php' );
}
