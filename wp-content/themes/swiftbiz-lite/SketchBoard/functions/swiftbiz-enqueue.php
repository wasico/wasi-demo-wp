...
function swiftbiz_lite_theme_stylesheet()
{
	...
	wp_enqueue_style('animation-stylesheet', get_template_directory_uri().'/css/swiftbiz-animation.css', false, $theme->Version);
	...
	/*GOOGLE FONTS*/
	wp_enqueue_style( 'google-Fonts-OpenSans+Raleway','//fonts.googleapis.com/css?family=Open+Sans:400,600,700,300|Raleway:400,500,600,800,700&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic', false, $theme->Version);
}
